        ...
        <section class="max-w-screen-xl px-4 md:px-8 pt-10 md:pt-0 mx-auto">
          <div class="flex flex-wrap justify-between">
            <div class="w-full lg:w-1/2 text-start   flex flex-col justify-center  mb-6 sm:mb-12 lg:mb-0">
              ...
              <p class="max-w-md text-start text-gray-800 dark:text-gray-300 xl:text-md  leading-relxed">
              ...
              <div class="flex mt-8">
                ...
                >
                  ...
                  <span class="relative inline-block border-2 text-green-100 border-green-500 rounded px-8 py-3 text-md font-semibold tracking-widest capitalize">
                    all courses
                  </span>
                </Link>
              </div>
            ...
            <div class="w-full lg:w-1/2 flex justify-center mb-12 md:mb-16">
              <div class="overflow-hidden relative z-10 top-12 bottom-0 md:top-16 left-12 md:left-16 -ml-12 lg:ml-0">
                <img
                  src={banner}
                  loading="lazy"
                  alt=""
