    ...
    <>
      <section className={`dark:bg-gray-800 bg-white pt-10 relative`}>
        ...
        >
          <g mask='url("#SvgjsMask1067")' fill="none">
            <rect
              width="85"
              height="85"
              clip-path='url("#SvgjsClipPath1068")'
              x="14.77"
              y="86.07"
        ...
        <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
          <div className="flex flex-col justify-center max-w-screen-xl lg:flex-row sm:mx-auto">
            <div className="relative lg:w-1/2 flex justify-center">
              <div class="grid grid-cols-2 md:grid-cols-2 gap-4 w-9/12">
            ...
            <div className="flex flex-col justify-center p-8  dark:text-gray-200 lg:p-12 lg:pl-10 lg:w-1/2">
              ...
              <ul class="flex flex-col">
                {list?.map(({ title }, i) => (
                  <li
                    key={i}
                    class="inline-flex items-center gap-x-3.5 py-3 text-sm font-semibold bg-white text-gray-800 -mt-px dark:bg-gray-800 dark:text-white"
                  >
