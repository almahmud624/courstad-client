        ...
        <tbody>
          {quizzes?.map((quiz) => (
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              <th
                scope="row"
                class="px-6 py-4 font-medium text-gray-900  dark:text-white w-[45%]"
              >
                <span className="line-clamp-1">{quiz?.question}</span>
              </th>
              <td class="px-6 py-4">
                <span className="line-clamp-1">{quiz?.video_title}</span>
              </td>
              ...
              <td class="px-6 py-4 flex gap-x-2">
                ...
                <Link className="edit" to={`/admin/quiz/edit/${quiz?._id}`}>
                  <svg
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
